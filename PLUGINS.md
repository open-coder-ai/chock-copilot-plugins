...
| [`protect-agent-config`](https://github.com/open-coder-ai/chock-catalog/blob/main/docs/protect-agent-config/README.md) | 0.0.3 | enforces | Guard against an agent hand-editing its own guardrails |
